...
var firstPerson = 'KAS'; // Replace with the actual name
var firstLocation = 'Puri,Odisha'; // Replace with the actual location

var secondPerson = 'DEVVV'; // Replace with the actual name
var secondLocation = 'Bhubaneswar, India';
...
var timeLeaveStamp = new Date(2024, 04, 09);

//first day of renewed contact (year, month, day)
var timeMeetStamp = new Date(2024, 03, 20);
